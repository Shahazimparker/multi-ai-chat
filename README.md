...
- Web search aggregation: primary fallback `Exa -> Firecrawl -> Tavily -> SerpAPI`, plus always-attempted LangSearch.
- URL intelligence (auto-triggered by links in chat text):
  ...
  - Generic aggregation: Firecrawl/Tavily/Exa extraction when site-specific readers do not return usable content
