...
4. **Reserved Output Tokens (4,000 Tokens)**:
   - Reserved output tokens set to 4,000 for models with $\ge 32\text{k}$ context (DeepSeek V4, Mistral, Claude Sonnet) to prevent premature answer truncation during complex code/reasoning generations.
