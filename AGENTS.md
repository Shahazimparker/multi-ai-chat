...
2. **Model Context Windows & Hard Caps**:
   - Each model accepts raw input up to its declared capacity (e.g., Codestral: 256K, Ministral 8B: 128K, Mistral Small / Medium / Large: 128K, DeepSeek V4: 128K, Claude Sonnet 5: 200K, Gemini/Groq: 5,999).
